...
#print("la persona: " +nombre+" "+apellido+" compro un auto marca "+marca+" de "+puertas+" color "+color+ " con un precio de $" +str(precio))
print("la persona: " +nombre+" "+apellido+" compro un auto marca "+marca+"  color "+color+ " con un precio de $" +str(precio))
#print("la persona: " +nombre+" "+apellido+" compro un auto marca "+marca+" "+puerta+ " con un precio de $" +str(precio))
